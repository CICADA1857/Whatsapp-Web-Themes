...
(function() {
    'use strict';
    var customCss2 = document.createElement("style");
    customCss2.innerHTML = `body #app [data-asset-chat-background-light], body #app [data-asset-chat-background-dark] { background-image: url(https://blog.og.art/content/images/2023/02/Comp_1.gif) !important;background-size: cover !important;background-position:center !important;opacity: 1  !important;filter: none !important; }`;
    document.head.appendChild(customCss2);
    var customCss3 = document.createElement("style");
    customCss3.innerHTML = 'body #app .app-wrapper-web .two, body #app .app-wrapper-web .three {height: 100%;top: 0;width: 100%;max-width: 100%}';
    document.head.appendChild(customCss3);

    var customCss = document.createElement("style");
    customCss.innerHTML = `.dark{
    --background-default: #030102;
    --background-default-rgb: 0,12,1;
    --background-document-with-captions: #030102;
    --background-document-with-captions-rgb: 0,12,1;
    --background-default-active: #000;
    --background-default-active-rgb: 0,12,1;
    --background-default-hover: #000;
    --background-default-hover-rgb: 0,12,1;
    --background-lighter: #030102;
    --background-lighter-rgb: 0,12,1;
    --background-lighter-active: #030102;
    --background-lighter-active-rgb: 0,12,1;
    --background-lighter-hover: #030102;
    --background-lighter-hover-rgb: 0,12,1;
    --intro-background: #030102;
    --active-tab-marker: #00a884;
    --active-tab-marker-rgb: 0,168,132;
    --app-background: #030102;
    ...
    --button-primary-destructive-color: #030102;
    ...
    --button-primary-destructive-spinner-color: #030102;
    ...
    --button-reject-background: #030102;
    ...
    --compose-panel-background: #030102;
    ...
    --conversation-panel-border: rgba(233,237,239,0);
    ...
    --drawer-section-background: #030102;
    ...
    --electron-deprecation-app-expired-header: #030102;
    --electron-deprecation-app-expired-header-rgb: 17,27,33;
    --electron-deprecation-app-expired-window: #030102;
    ...
    --location-cluster-background: #030102;
    ...
    --panel-header-background: #030102;
    ...
    --product-thumb-background: #030102;
    ...
    --poll-checkmark-receiver: #030102;
    ...
    --poll-modal-background-color: #030102;
    --poll-modal-background-color-rgb: 17,27,33;
    --poll-modal-footer-background-color: #030102;
    ...
    --ptt-draft-waveform-background-border: #030102;
    ...
    --rich-text-panel-background: #030102;
    --rich-text-panel-background-rgb: 32,44,51;
    --search-container-background: #030102;
    --search-container-background-rgb: 17,27,33;
    --search-input-background: #030102;
    --search-input-background-rgb: 32,44,51;
    --search-input-container-background: #030102;
    --search-input-container-background-rgb: 17,27,33;
    --search-input-container-background-active: #030102;
    ...
    --status-link-preview-title: #030102;
    ...
    --reactions-bubble-border: #030102;
    ...
    --forward-caption-preview-background: #030102;
    --forward-caption-preview-background-rgb: 32,44,51;
    --forward-caption-preview-content: #030102;
    --forward-caption-preview-content-rgb: 17,27,33;
    --skeleton-gradient-background-sides: #030102;
    --skeleton-gradient-background-sides-rgb: 32,44,51;
    --skeleton-gradient-background-middle: #030102;
    --skeleton-gradient-background-middle-rgb: 17,27,33;
}
._64p9P{background-color:#000c01;}*{color:rgba(74, 239, 152, 1);}html::after{content:" ";display:block;z-index: 99999;position:absolute;top:0;left:0;bottom:0;right:0;background:linear-gradient(rgba(18, 16, 16, 0) 50%, rgba(0, 0, 0, 0.25) 50%),linear-gradient(90deg, rgba(255, 0, 0, 0.06), rgba(0, 255, 0, 0.02), rgba(0, 0, 255, 0.06));background-size:100% 2px,3px 100%;pointer-events:none}
`;
